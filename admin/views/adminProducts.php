...
#productTable td { text-overflow: ellipsis;
overflow: hidden; white-space: nowrap; }
#productTable td input {  }
</style>
<div ng-controller="productCtrl">
<table id="productTable" class="table table-responsive table-striped table-bordered">
<tr>
...
<button ng-click="deleteProduct(item.id)" class="btn btn-xs btn-primary">
Delete
</button>

</td>
</tr>
<tr ng-class="{danger: editedProduct}" class="bg-primary">
